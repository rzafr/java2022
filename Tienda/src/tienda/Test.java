...
public class Test {
	...
	public static void main(String[] args) {
		...
		//TERMINAR ESTO CON UN MENÚ SI VAS CON TIEMPO
		...
		ClienteRegistrado cr1 = new ClienteRegistrado("Rubén", "Díaz Díaz", "456", "Cuevas", "Alli",
			"email", "passw", LocalDate.of(2020,10,7));
		
		
		//probar a poner contraseña al cliente en TestPedido y luego chequearla antes de hacer el
		//siguiente paso.
		...
		ClienteNoRegistrado cnr1 = new ClienteNoRegistrado("Alfonso", "Martínez", "456", "Cuevas", "Alli");
